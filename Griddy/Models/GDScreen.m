...
- (NSRect) getCGFrameForGridRect: (NSRect) gridRect {
    ...
    cocoaFrame.origin.y = [primaryScreen frame].size.height - cocoaFrame.origin.y - cocoaFrame.size.height; // flip the coordinate system, the deducate the height
    return cocoaFrame;
}
